          ...
          children: [
              ...
              new Paragraph({
                ...
                children: [
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepTwoData.textArea1}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepTwoData.textArea2}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepTwoData.textArea3}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepThreeData3.textArea4}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepThreeData3.textArea5}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepThreeData3.textArea6}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepFourData4.textArea7}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepFourData4.textArea8}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepFourData4.textArea9}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepFiveData5.textArea13}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepFiveData5.textArea14}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepFiveData5.textArea15}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepSixData6.textArea16}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepSixData6.textArea17}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
                    ...
                    new TextRun({
                        break:2,
                        text: `${this.commonService.schnStepSixData6.textArea18}`,
                        italics: true,
                        size: 24,
                        color: "8282ff",
                    }),
